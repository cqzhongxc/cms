        ...
        <div class="main-content container-fluid">
            <div class="splash-container">
                <div class="card card-border-color card-border-color-primary">
                    <div class="card-header"><img src="{{asset('theme/beagle/img/logo-xx.png')}}" alt="logo" width="120"
                        ...
                        <form action="/admin/login" method="post">
                            ...
                            <div class="login-form">
                                <div class="form-group">
                                    <input id="name" type="text" name="name" placeholder="请输入后台账号" value="admin"
                                           autocomplete="off" class="form-control">
                                </div>
                                <div class="form-group">
                                    <input id="password" type="password" name="password" value="123456" placeholder="登录密码"
                                           class="form-control">
                                </div>
